    ...
    element.innerHTML = `
      <div style="padding: 40px; font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; color: #1e293b; line-height: 1.6;">
        ...
        <div style="margin-bottom: 30px;">
          ...
          <p style="font-size: 16px; color: #475569;">Fully managed 7-day tour including Premium 5-Star Hotels, Domestic Flights, All Meals, and Dedicated Transfers.</p>
        </div>
  ...
  return (
    <section id="why" className="py-16 bg-slate-900 relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        >
          {/* Card 1 */}
          <motion.div variants={itemVariants} className="bg-slate-900 rounded-3xl p-8 group hover:-translate-y-3 transition-all duration-500 relative overflow-hidden shadow-xl hover:shadow-2xl">
          ...
          {/* Card 2 */}
          <motion.div variants={itemVariants} className="bg-slate-900 rounded-3xl p-8 group hover:-translate-y-3 transition-all duration-500 relative overflow-hidden shadow-xl hover:shadow-2xl border-primary-100/50">
            <div className="absolute inset-0 z-0">
