...
const FinalCTA = () => {
  const stats = [
    ...
    { icon: <Clock className="w-5 h-5" />, value: '6 Days', label: '3 Cities, Fully Managed' },
  ];

  return (
    <section className="py-24 bg-secondary-900 relative overflow-hidden">
      {/* Top gradient fade */}
      <div className="absolute inset-0 bg-gradient-to-b from-secondary-900 via-secondary-900 to-secondary-900 z-0 opacity-5"></div>
      ...
      <div className="container mx-auto px-4">
        ...
        >
          ...
          <div className="absolute top-0 left-0 w-full h-full overflow-hidden z-0">
            ...
            <div className="absolute -bottom-[50%] -right-[10%] w-[70%] h-[150%] bg-accent-500/20 blur-[100px] rounded-full mix-blend-screen animate-pulse" style={{ animationDelay: '1s' }}></div>
          </div>
