...
import {
  Trophy, Medal, Check, Sparkles, ArrowRight,
  Download, Megaphone, Rocket, Eye, Target, ShieldCheck
} from 'lucide-react';
import { SITE_CONFIG } from '@/constants/siteConfig';

/**
 * Deep-Dive Sponsorship Presentation Deck Section
 */
export const SponsorDeckSection = () => {
    ...
    <div id="sponsor-deck" ref={containerRef} className="relative bg-secondary-900 text-white selection:bg-primary-500/30">
      ...
      <div className="relative h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center px-4 max-w-6xl mx-auto">
          ...
          >
            <a
              href={SITE_CONFIG.contact.sponsorshipEmailHref}
              ...
              >
                <div className="bg-secondary-900 rounded-[38px] h-full p-10 flex flex-col relative overflow-hidden group">
                  ...
                  <div className="mb-10 relative">
                    <div
                      className={`w-20 h-20 rounded-[28px] bg-gradient-to-br ${tier.color} flex items-center justify-center text-secondary-900 shadow-2xl mb-8 group-hover:scale-110 transition-transform duration-500`}
                    >
                      {tier.icon}
                    </div>
                  ...
                  <p className="text-secondary-400 text-sm mb-10 font-medium">
                    Best for: <span className="text-secondary-200">{tier.bestFor}</span>
                  </p>
                  ...
                  <a
                    href={SITE_CONFIG.contact.sponsorshipEmailHref}
                    className={`w-full py-5 rounded-2xl font-bold text-lg text-center transition-all duration-300 ${
                      tier.popular
                        ? 'bg-yellow-500 text-secondary-900 hover:bg-yellow-400 shadow-2xl'
...
export default SponsorDeckSection;
