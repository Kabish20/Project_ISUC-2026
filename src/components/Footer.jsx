      ...
      <div className="container mx-auto px-4">
          ...
          <div className="lg:col-span-1">
            ...
            <div className="flex gap-3">
              <a href="#" aria-label="LinkedIn"
                className="w-9 h-9 rounded-full bg-slate-800 flex items-center justify-center text-slate-400 hover:bg-blue-700 hover:text-white transition-all duration-200 hover:scale-110">
                <svg className="w-4 h-4 fill-current" viewBox="0 0 24 24">
                  <path d="M19 0h-14c-2.761 0-5 2.239-5 5v14c0 2.761 2.239 5 5 5h14c2.762 0 5-2.239 5-5v-14c0-2.761-2.238-5-5-5zm-11 19h-3v-11h3v11zm-1.5-12.268c-.966 0-1.75-.79-1.75-1.764s.784-1.764 1.75-1.764 1.75.79 1.75 1.764-.783 1.764-1.75 1.764zm13.5 12.268h-3v-5.604c0-3.368-4-3.113-4 0v5.604h-3v-11h3v1.765c1.396-2.586 7-2.777 7 2.476v6.759z" />
                </svg>
              </a>
              <a href="#" aria-label="Instagram"
                className="w-9 h-9 rounded-full bg-slate-800 flex items-center justify-center text-slate-400 hover:bg-pink-600 hover:text-white transition-all duration-200 hover:scale-110">
                <svg className="w-4 h-4 fill-current" viewBox="0 0 24 24">
            ...
            <ul className="space-y-4">
              <li>
                <a href="mailto:info@travizly.com"
                  ...
                  <div className="w-9 h-9 rounded-lg bg-slate-800 flex items-center justify-center group-hover:bg-blue-600 transition-colors">
                    <Mail className="w-4 h-4" />
                  </div>
                  <div>
                    <div className="text-xs text-slate-500 mb-0.5">Enquiries &amp; Partnerships</div>
              ...
              <li>
                <a href="tel:+966558891231"
                  className="flex items-center gap-3 text-slate-400 hover:text-white transition-colors group">
                  <div className="w-9 h-9 rounded-lg bg-slate-800 flex items-center justify-center group-hover:bg-green-600 transition-colors">
                    <Phone className="w-4 h-4" />
                  </div>
                  <div>
                    <div className="text-xs text-slate-500 mb-0.5">Saudi Arabia</div>
              ...
              <li>
                <a href="tel:+918072896589"
                  className="flex items-center gap-3 text-slate-400 hover:text-white transition-colors group">
                  <div className="w-9 h-9 rounded-lg bg-slate-800 flex items-center justify-center group-hover:bg-orange-600 transition-colors">
                    <Phone className="w-4 h-4" />
                  </div>
                  <div>
                    <div className="text-xs text-slate-500 mb-0.5">India</div>
                    <div className="text-sm font-medium">+91 80728 96589</div>
                  </div>
                </a>
              </li>
              <li className="flex items-start gap-3 text-slate-400">
                <div className="w-9 h-9 rounded-lg bg-slate-800 flex items-center justify-center mt-0.5 shrink-0">
                  <MapPin className="w-4 h-4" />
                </div>
                <div>
                  <div className="text-xs text-slate-500 mb-0.5">Tour Cities</div>
                  <div className="text-sm font-medium">Delhi · Mumbai · Hyderabad · Chennai</div>
                  <div className="text-xs text-slate-500 mt-0.5">3–9 July 2026</div>
                </div>
              </li>
            </ul>
          </div>
        ...
        <div className="pt-8 border-t border-secondary-800 flex flex-col md:flex-row justify-between items-center gap-4">
          ...
          <div className="flex items-center gap-6 text-sm">
            ...
            <span className="text-slate-700 font-medium">#ISUC2026</span>
          </div>
        </div>
      </div>
    </footer>
