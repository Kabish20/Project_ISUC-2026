  ...
  return (
    <section id="format" className="py-16 relative overflow-hidden bg-secondary-900 text-white">
      ...
      <div className="absolute inset-0 z-0">
        ...
        />
        <div className="absolute inset-0 bg-gradient-to-b from-secondary-900/90 via-secondary-900/60 to-secondary-900"></div>
      </div>
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        <div className="relative max-w-5xl mx-auto">
          ...
          <div className="hidden md:block absolute top-1/2 left-0 w-full h-0.5 bg-secondary-800 -translate-y-1/2 z-0"></div>
            ...
            {steps.map((step, index) => (
              ...
              >
                ...
                <div className="absolute inset-0 z-0">
                  ...
                  <div className="absolute inset-0 bg-gradient-to-t from-secondary-900 via-secondary-900/80 to-secondary-900/60 transition-all duration-500 group-hover:from-secondary-900/90 group-hover:via-secondary-900/70 group-hover:to-secondary-900/40"></div>
                </div>
                ...
                <div className="relative z-10">
                  ...
                  <div className="text-center">
                    <h3 className="text-2xl font-display font-bold text-white mb-4 group-hover:text-accent-400 transition-colors duration-300">{step.title}</h3>
        ...
        >
          ...
          <br/>
          <a href="#" className="inline-flex items-center gap-2 text-accent-400 font-semibold hover:text-accent-300 transition-colors">
